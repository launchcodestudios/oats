...
gulp.task('js-build-bundle', function () {
	return gulp.src([
			...
			'build/js/oats.min.js',
		])
		.pipe(concat('oats-bundle.min.js'))
...
gulp.task('css-build-bundle', function () {
	return gulp.src([
			...
			'build/css/oats.min.css',
		])
		.pipe(concat('oats-bundle.min.css'))
...
gulp.task('watch', function (cb) {
	gulp.watch('src/**/*.scss', gulp.series('sass-lint', 'sass-build', 'copy-files', 'css-build-bundle', 'sass-notify'));
	gulp.watch('src/*.js', gulp.series('js-hint', 'js-build', 'copy-files', 'js-build-bundle', 'js-notify'));
...
// Build files.
gulp.task('build', 
	gulp.series('clean', 'js-hint', 'js-build', 'copy-files', 'sass-lint', 'sass-build', 'html-build', 'js-build-bundle', 'css-build-bundle', 'build-notify')
);
